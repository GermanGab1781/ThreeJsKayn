  ...
  return (
    <div onClick={onC} className='border border-slate-700 cursor-pointer'>
      ...
      <div className='group border-t-2 bg-black border-slate-700'>
        ...
        <div className='absolute hidden group-hover:flex bg-black p-3 md:w-fit w-full h-fit max-h-full md:overflow-hidden overflow-y-auto md:min-h-[15rem] -top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-full'>
